...
const All_Search = ({ searchData, searchID }) => {
  return (
    <>
     <h1 className="col-span-4 sm:col-span-2 md:col-span-3 lg:col-span-4 text-center mb-4 text-3xl font-extrabold leading-none tracking-tight text-amber-500 md:text-4xl dark:text-gray-300 dark:bg-amber-800 bg-slate-800 py-2">
