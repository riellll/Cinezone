...
export async function generateMetadata({ params }) {
  ...
  const movie = await fetch(
    `https://api.themoviedb.org/3/tv/${params.id}?language=en-US&api_key=${process.env.API_KEY}`
  ).then((res) => res.json());
  ...
  return (
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white sm:px-0 min-[320px]:px-8">
